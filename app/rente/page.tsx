...
const renteTariffs: TariffRow[] = [
  {
    id: 'allianz-privatrente',
    provider: 'Allianz',
    logoText: 'ALZ',
    tariffName: 'PrivatRente KomfortDynamik',
    priceMonthly: 100.00,
    priceYearly: 1200.00,
    rating: 4.9,
    reviewCount: 3890,
    benefits: ['Garantierte lebenslange Rente oder Kapitalabfindung', 'Attraktive Ertragsanteilsbesteuerung im Alter', 'Flexible Zuzahlungen & Entnahmen jederzeit möglich', 'Vererbbarkeit des Kapitals an Hinterbliebene'],
    bonus: 'Hohe Finanzstärke & Stabilität',
    isTestsieger: true,
    ctaText: 'Jetzt Rente berechnen'
  },
  {
    id: 'wwk-fondsrente',
    provider: 'WWK',
    logoText: 'WWK',
    tariffName: 'Premium FondsRente protect',
    priceMonthly: 100.00,
    priceYearly: 1200.00,
    rating: 4.8,
    reviewCount: 2150,
    benefits: ['Freie Auswahl aus Top-ETFs & nachhaltigen Fonds', 'Intelligentes Garantie- und Absicherungssystem', 'Steuerfreies Rebalancing während der Sparphase', 'Flexibler Rentenbeginn zwischen 62 und 85'],
    isTestsieger: false,
  ...
  return (
    <div className="py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14">
          <ComparisonTable 
            title="Top bewertete Rentenversicherungen 2026"
            subtitle="Hervorragende Renditechancen kombiniert mit solider Absicherung"
            productType="Private Rentenversicherung"
            tariffs={renteTariffs}
            widgetSlug="/rente"
          />
        </div>
