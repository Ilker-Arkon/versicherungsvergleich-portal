...
const faqs = [
  {
    question: 'Wie läuft der Abschluss für Motorradversicherung ab?',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight mt-3">
            Motorradversicherung: <span className="text-blue-600">Beste Tarife im Vergleich</span>
          </h1>
          <p className="mt-4 text-slate-600 text-base leading-relaxed">
            Saison- & Ganzjahreskennzeichen für Bikes & Roller im Sparvergleich.
          </p>
        </div>
        <div className="mb-14">
          <ComparisonTable 
        ...
        <FAQAccordion items={faqs} title="Häufige Fragen zu Motorradversicherung" />
      </div>
    </div>
  );
}