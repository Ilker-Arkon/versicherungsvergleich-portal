...
const tariffs: TariffRow[] = [
  {
    ...
    provider: 'HUK24',
    logoText: 'HUK',
    tariffName: 'Hausrat Comfort Plus',
    priceMonthly: 6.90,
    priceYearly: 82.80,
    rating: 4.9,
    reviewCount: 2870,
    benefits: ['Neuwertentschädigung ohne Abzüge', 'Fahrraddiebstahl 24h inkl.', 'Grobe Fahrlässigkeit mitversichert', 'Elementarschäden zubuchbar'],
  ...
  },
  {
    ...
    provider: 'Allianz',
    logoText: 'ALZ',
    tariffName: 'Hausrat Komfort',
    priceMonthly: 8.50,
    priceYearly: 102.00,
    rating: 4.8,
    reviewCount: 3120,
    benefits: ['Unterversicherungsverzicht ab 650 EUR/m2', 'Smart-Home-Geräte mitversichert', 'Überspannungsschäden inkl.', 'Reisegepäck bis 3.000 EUR'],
    isTestsieger: false,
