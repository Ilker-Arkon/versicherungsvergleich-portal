      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight mt-3">
            Hausrat&shy;versicherung <span className="text-emerald-600">Vergleich</span>
          </h1>
          ...
          <div className="mt-4 flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 text-xs font-semibold text-emerald-700 max-w-2xl mx-auto text-left">
            <span className="flex items-start"><CheckCircle2 className="w-4 h-4 mr-2 text-emerald-500 shrink-0 mt-0.5" /> Neuwertentschädigung</span>
            <span className="flex items-start"><CheckCircle2 className="w-4 h-4 mr-2 text-emerald-500 shrink-0 mt-0.5" /> Fahrraddiebstahl 24h</span>
            <span className="flex items-start"><CheckCircle2 className="w-4 h-4 mr-2 text-emerald-500 shrink-0 mt-0.5" /> Elementarschutz zubuchbar</span>
          </div>
          <div className="mt-4">
        ...
        <div className="premium-card p-6 sm:p-8 mb-14">
          <h2 className="text-xl font-bold text-slate-900 mb-4 flex items-start gap-2.5">
            ...
            <span>Wichtige Kriterien beim Hausrat-Vergleich</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 text-sm text-slate-600">
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">Der Versicherer ersetzt den vollen Wiederbeschaffungswert — ohne Abzug für Alter oder Abnutzung.</p>
            </div>
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
              <p className="font-bold text-slate-900 mb-1">2. Grobe Fahrlässigkeit</p>
              <p className="text-xs text-slate-500 leading-relaxed">Im Schadenfall zahlt der Versicherer auch dann, wenn Sie den Schaden grob fahrlässig verursacht haben (z.B. vergessene Kerze).</p>
            </div>
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
              <p className="font-bold text-slate-900 mb-1">3. Elementarschadenschutz</p>
              <p className="text-xs text-slate-500 leading-relaxed">Ergänzen Sie den Standard-Hausratschutz um Elementargefahren wie Überschwemmung und Starkregen.</p>
            </div>
          </div>
        </div>

        <FAQAccordion items={faqs} title={<>Häufige Fragen zur Hausrat&shy;versicherung</>} />
      </div>
    </div>
  );
}
