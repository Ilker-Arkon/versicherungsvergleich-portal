      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight mt-3">
            Privat&shy;haftpflicht <span className="text-emerald-600">Vergleich</span>
          </h1>
          ...
          <div className="mt-4 flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 text-xs font-semibold text-emerald-700 max-w-2xl mx-auto text-left">
            <span className="flex items-start"><CheckCircle2 className="w-4 h-4 mr-2 text-emerald-500 shrink-0 mt-0.5" /> Deckung bis 50 Mio. Euro</span>
            <span className="flex items-start"><CheckCircle2 className="w-4 h-4 mr-2 text-emerald-500 shrink-0 mt-0.5" /> Für Singles und Familien</span>
            <span className="flex items-start"><CheckCircle2 className="w-4 h-4 mr-2 text-emerald-500 shrink-0 mt-0.5" /> Sofort-Deckung möglich</span>
          </div>
          <div className="mt-4">
        ...
        <div className="premium-card p-6 sm:p-8 mb-14">
          <div className="flex items-start space-x-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 leading-snug">Existenzschutz vor Schadenersatz: Warum die Privathaftpflicht unverzichtbar ist</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">Eine gute Privathaftpflicht schützt dich vor finanziellen Forderungen in Millionenhöhe – und das für wenige Euro im Monat.</p>
            </div>
            <div className="p-4 bg-blue-50 rounded-xl border border-blue-200/60">
              ...
              <p className="text-xs text-blue-700 leading-relaxed">Unberechtigte Ansprüche Dritter werden von der Versicherung auf deren Kosten geprüft und abgewehrt.</p>
            </div>
          </div>
        </div>

        <FAQAccordion items={faqs} title={<>Häufige Fragen zur Privat&shy;haftpflicht&shy;versicherung</>} />
      </div>
    </div>
  );
}
