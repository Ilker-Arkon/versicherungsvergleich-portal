...
const haftpflichtTariffs: TariffRow[] = [
  {
    id: 'huk-phv-plus',
    provider: 'HUK24',
    logoText: 'HUK',
    ...
    bonus: 'Bestseller Stiftung Warentest',
    isTestsieger: true,
  ...
  return (
    <div className="py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14">
          <ComparisonTable 
            title="Empfohlene Haftpflicht- und Hausrat-Tarife"
            subtitle="Testsieger mit exzellentem Preis-Leistungs-Verhältnis"
            productType="Sachversicherung"
            tariffs={haftpflichtTariffs}
