...
const rlvTariffs: TariffRow[] = [
  {
    id: 'dlv-risiko-plus',
    provider: 'DLVAG (Allianz)',
    logoText: 'DLV',
    tariffName: 'RisikoLeben Premium',
    priceMonthly: 7.80,
    priceYearly: 93.60,
    rating: 4.9,
    reviewCount: 2980,
    benefits: ['Hohe Todesfallsumme ab 100.000 € bis 1 Mio. €', 'Verlängerungsoption ohne Gesundheitsprüfung', 'Sofortauszahlung bei schwerer Krankheit', 'Besonders günstige Nichtrauchertarife'],
    bonus: 'Top-Preise für Nichtraucher',
    isTestsieger: true,
    ctaText: 'Jetzt Beitrag berechnen'
  },
  {
    id: 'cosmos-risiko',
    provider: 'CosmosDirekt',
    logoText: 'COS',
    tariffName: 'Comfort Schutz RLV',
    priceMonthly: 6.90,
    priceYearly: 82.80,
    rating: 4.8,
    reviewCount: 3410,
    benefits: ['Gefallene Beiträge bei linearer / fallender Summe', 'Ideal für Baufinanzierungs-Absicherung', 'Kinderbonus bei Geburt', 'Schnelle Online-Beantragung'],
    isTestsieger: false,
  ...
  return (
    <div className="py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14">
          <ComparisonTable 
            title="Beliebte Risikolebensversicherungen im Vergleich"
            subtitle="Geprüfte Tarife mit transparenten Annahmerichtlinien"
            productType="Risikolebensversicherung"
            tariffs={rlvTariffs}
            widgetSlug="/risikoleben"
          />
        </div>
