...
const OUT_DIR = 'C:/Users/Home/.gemini/antigravity/brain/2dc5e61b-4a81-478b-97cb-9bdd0ce0162e/audit-screenshots/phase3-gesundheit';
...
async function run() {
  console.log('🚀 Starte Audit für Phase 3: Gesundheit & Kranken (4 Unterseiten)...');
  ...
  fs.writeFileSync(path.join(OUT_DIR, 'phase3-audit-report.json'), JSON.stringify(results, null, 2));
  console.log(`\n✅ Phase 3 Audit abgeschlossen. Ergebnisse in ${OUT_DIR}`);
  await browser.close();
}
