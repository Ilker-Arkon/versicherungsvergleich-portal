...
const OUT_DIR = 'C:/Users/Home/.gemini/antigravity/brain/2dc5e61b-4a81-478b-97cb-9bdd0ce0162e/audit-screenshots/phase4-vorsorge';
...
const pages = [
  { path: '/berufsunfaehigkeit', name: 'berufsunfaehigkeit' },
  { path: '/risikoleben', name: 'risikoleben' },
  { path: '/rente', name: 'rente' },
  { path: '/unfallversicherung', name: 'unfallversicherung' },
  { path: '/riester-rente', name: 'riester-rente' },
  { path: '/ruerup-rente', name: 'ruerup-rente' },
  { path: '/pflegezusatz', name: 'pflegezusatz' },
  { path: '/lebensversicherung', name: 'lebensversicherung' },
];

async function run() {
  console.log('🚀 Starte Audit für Phase 4: Vorsorge & Leben (8 Unterseiten)...');
  ...
  const reportFile = path.join(OUT_DIR, 'phase4-audit-report.json');
