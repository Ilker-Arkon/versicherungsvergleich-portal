...
const OUT_DIR = 'C:/Users/Home/.gemini/antigravity/brain/2dc5e61b-4a81-478b-97cb-9bdd0ce0162e/audit-screenshots/phase6-service';
...
async function run() {
  console.log('🚀 Starte Audit für Phase 6: Service & Rechtliches (5 Seiten + Homepage)...');
  ...
  const reportFile = path.join(OUT_DIR, 'phase6-audit-report.json');
